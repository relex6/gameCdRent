<template>
  <div>
    <el-card id="box-card">
      <img id="titleIcon" src="@/assets/rent.png">
      <span id="title">租赁订单</span>
      <el-input
      ...
      <div class="gametable">
        <el-table
        :data="tableData.filter(data => (!search || data.gameid.title.includes(search)) && (data.type === '租赁'))"
        border
        height="486"
        style="width: 960px;margin: 100px auto;">
          ...
          <el-table-column
            ...
            width="140">
            <template slot-scope="scope">
              <el-button @click="returnback(scope.row)" type="text" size="small">归还</el-button>
